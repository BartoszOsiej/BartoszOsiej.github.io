---
layout: writing-sample
title: "Detecting ransomware with eBPF in Rust"
client: "talus-process-monitor (original, published 2026-09-13)"
canonical_url: https://bartoszosiej.github.io/content/ebpf-ransomware-monitor-lessons
date: 2026-09-13
tags: [ebpf, rust, security, ransomware]
published: true
summary: "Behavioural eBPF tracing (execve/openat + per-CPU perf buffers) catches ransomware by the shape of its damage — and the hard part is scoring patterns without crying wolf on every cargo build."
---
